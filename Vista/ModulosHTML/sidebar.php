                ...
                <section class="sidebar" id="sidebar">
                    ...
                    <!-- VALIDACION DE SESION E INCLUSION DE REDES SOCIALES Y AJUSTES DE PERFIL -->
                        ...
                        <!--ENLACES DE LAS SECCIONES DE LA PAGINA PRINCIPAL -->
                            <!-- GUIA DEL HUMANO -->
                            <a href="<?=SERVER?>Ajax/guiaAjax.php?file=<?=htmlspecialchars($s::encryption('Vista/Recursos/PDF/GUIA-DEL-HUMANO.pdf'))?>" target="_blank">
    ...
    <!-- BARRA LATERAL ADMINISTRADOR -->
                ...
                <section class="sidebar sidebar-admin" id="sidebar">
                    ...
                    <div class="menubar-content menubar-admin" id="menubar-content">
                        ...
                        <!--ENLACES DE LAS SECCIONES DE LA PAGINA PRINCIPAL -->
                            <!-- GUIA DEL HUMANO -->
                            <a href="<?=SERVER?>Ajax/guiaAjax.php?file=<?=htmlspecialchars($s::encryption('Vista/Recursos/PDF/GUIA-DEL-HUMANO.pdf'))?>&rnd=<?=htmlspecialchars($s::encryption(rand(0,999999999999)))?>" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height="20px"  width="20px" fill="#cfd6e0" loading="lazy"><path d="M240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h480q33 0 56.5 23.5T800-800v640q0 33-23.5 56.5T720-80H240Zm0-80h480v-640h-80v280l-100-60-100 60v-280H240v640Zm0 0v-640 640Zm200-360 100-60 100 60-100-60-100 60Z"/></svg> Guía del humano
                            </a>
                            <!-- BLOG -->
