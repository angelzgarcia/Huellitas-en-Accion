...
<footer class="foot">
    ...
    <div class="col-foot col3">
        <div class="links-help">
            ...
            <a href="<?=SERVER?>organizations">Directorio</a>
            <a href="<?=SERVER?>organizations">Apoyo cercano</a>
        </div>

        <div class="links-social-foot">
            <a href="">
    ...
    <div class="copyrigth-col">
        © <?=date('Y')?> Fundación <?=PROYECT?> | Todos los derechos reservados
    </div>
