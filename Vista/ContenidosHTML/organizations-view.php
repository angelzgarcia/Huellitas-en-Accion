...
<body class="body-index">
    <main class="content-page">
        ...
        <div id="mapOrg" class="mapOrganizaciones" style="margin: auto; margin-block-start: 6em; height: 500px; width: 100%;"></div>
...
<script>
    ...
    function initMap() {
        ...
        map = new google.maps.Map(document.getElementById("mapOrg"), {
            center: center,
            zoom: 5,
