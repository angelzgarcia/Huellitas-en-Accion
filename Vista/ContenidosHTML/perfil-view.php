...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        $('.update-post').click(function(event) {
            ...
            const tipoanimal = this.getAttribute('data-tipoanimal');
            const raza = this.getAttribute('data-raza');
            const estadoSalud = this.getAttribute('data-estadosalud');
            const status = this.getAttribute('data-status');
            const tamanio = this.getAttribute('data-tamanio');
            ...
            async function editarPost(postId, estadoSalud, status) {
            const { value: formValues } = await Swal.fire({
                ...
                <?php if(!$esUsuario){ $toast; } ?>
                preConfirm: () => {
                    const estadoSalud = document.getElementById('edit-estado-salud').value;
                    const status = document.getElementById('edit-status').value;

                    if (!status || !estadoSalud) {
        ...
        editarPost(postId, estadoSalud, status);
